...
@if (Session('questionEmpty'))
    <div class="modifAlert">
        <div class="alert">
            <span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span>
            {{Session::get('questionEmpty')}}
        </div>
    </div>
@endif
                            ...
                            <div class="fontFamily">
                                ...
                                <div class="display">
                                    ...
                                    <div class="display_block">
                                        <a href="/homePage/profile/{{ $questionAndEtc->User->id }}" class="username" style="text-decoration: none">{{$questionAndEtc->User->name}}</a>
                                        <p class="time"><b>Create At: </b>{{$questionAndEtc->questionCreationDate}}</p>
                                    </div>
                                </div>
                                <a href="/homePage/answer/{{ $questionAndEtc->id }}" class="btn btn-danger btn-sm button" style="color: white">Answer</a>
                            </div>
                        </div>
                    {{-- </div> --}}
                </div>
