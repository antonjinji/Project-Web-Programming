    ...
    <div class="row justify-content-center">
        <div class="col-md-7">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="header-text">Edit User</div>
                    <form method="POST" action="/homePage/manageUser/{{ $user->id }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-2">
                            <div class="col-md">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input @error('gender') is-invalid @enderror" type="radio" name="gender" id="male" value="{{ $user->gender }}" <?php if($user->gender == "male") { echo 'checked="checked"'; } ?>>
                                    <label class="form-check-label @error('gender') is-invalid @enderror" for="male">Male</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input @error('gender') is-invalid @enderror" type="radio" name="gender" id="female" value="{{ $user->gender }}" <?php if($user->gender == "female") { echo 'checked="checked"'; } ?>>
                        ...
                        <div class="form-group row">
                            <div class="col-md">
                                <textarea name="address" class="form-control @error('address') is-invalid @enderror" id="address" rows="2" placeholder="Address">{{ $user->address }}</textarea>
